...
class font():
    def __init__(self, game_win, font_png, font_color="white", font_table=[]):
        ...
        self.font_table = {"w_and_h":(13,10), "space": 0.5, "A":(0, 0), "B":(1, 0), "C":(2, 0), "D":(3, 0), "E":(4, 0),
                           ...
                           "x":(10, 3), "y":(11, 3), "z":(12, 3), "1":( 0, 5), "2":(1,5), "3":(2,5),"4":(3,5), "0":(9,5), "_":(1,6), "-":(6, 4), "(":(9,4), ")":(10,4),
        ...
        self.spacing = {"A":(1, 0, 2, 0), "B":(1, 0, 2, 0), "C":(1, 0, 2, 0), "D":(1, 0, 2, 0), "E":(1, 0, 2, 0), "F":(1, 0, 2, 0),
                        ...
                        "k":(1, 0, 0, 0), "l":(0, 0, 4, 0), "m":(0, 0, 0, 0), "n":(0, 0, 3, 0), "o":(0, 0, 3, 0), "p":(1, 0, 0, 0),
                        "q":(1, 0, 0, 0), "r":(1, 0, 0, 0), "s":(2, 0, 1, 0), "t":(2, 0, 2, 0), "u":(1, 0, 0, 0), "v":(1, 0, 0, 0),
                        "w":(0, 0, 1, 0), "x":(2, 0, 2, 0), "y":(2, 0, 2, 0), "z":(2, 0, 2, 0), "1":(1, 0, 2, 0), "2":(1, 0, 2, 0),
                        "3":(1, 0, 2, 0), "4":(1, 0, 2, 0), "5":(1, 0, 2, 0), "6":(1, 0, 2, 0), "7":(1, 0, 2, 0), "0":(1, 0, 2, 0),
                        "_":(1, 0, 1, 0),
