...
class font():
    def __init__(self, game_win, font_png, font_color="white", font_table=[]):
        ...
        self.spacing = {"A":(1, 0, 2, 0), "B":(1, 0, 2, 0), "C":(1, 0, 2, 0), "D":(1, 0, 2, 0), "E":(1, 0, 2, 0), "F":(1, 0, 2, 0),
                        ...
                        "M":(0, 0, 1, 0), "N":(1, 0, 1, 0), "O":(1, 0, 1, 0), "P":(1, 0, 2, 0), "Q":(1, 0, 1, 0), "R":(1, 0, 2, 0),
                        "S":(1, 0, 2, 0), "T":(1, 0, 1, 0), "U":(1, 0, 2, 0), "V":(1, 0, 1, 0), "W":(0, 0, 0, 0), "X":(1, 0, 1, 0),
                        "Y":(1, 0, 1, 0), "Z":(1, 0, 1, 0), "a":(1, 0, 0, 0), "b":(1, 0, 2, 0), "c":(1, 0, 2, 0), "d":(1, 0, 2, 0),
                        "e":(1, 0, 2, 0), "f":(1, 0, 3, 0), "g":(0, 0, 3, 0), "h":(0, 0, 3, 0), "i":(0, 0, 6, 0), "j":(0, 0, 3, 0),
                        "k":(0, 0, 4, 0), "l":(0, 0, 3, 0), "m":(0, 0, 2, 0), "n":(0, 0, 1, 0), "o":(0, 0, 3, 0), "p":(1, 0, 2, 0),
                        "q":(2, 0, 1, 0), "r":(1, 0, 2, 0), "s":(2, 0, 1, 0), "t":(2, 0, 2, 0), "u":(1, 0, 2, 0), "v":(2, 0, 2, 0),
                        "w":(1, 0, 1, 0), "x":(2, 0, 2, 0), "y":(2, 0, 2, 0), "z":(2, 0, 2, 0), "1":(1,0,2,0)} 
...
if __name__ == "__main__":
    test_win = p.display.set_mode((700,700))
    test_font = font(test_win, "../symbols/standard")
    test_font.draw("ABCDEFGHIIJKLMNOPQRSTUVWXYZ".lower(), 20, (5,5))
    p.display.flip()