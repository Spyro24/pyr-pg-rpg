...
class font():
    def __init__(self, game_win, font_png, font_color="white", font_table=[]):
        ...
        self.font_table = {"w_and_h":(13,10), "space": 0.5, "A":(0, 0), "B":(1, 0), "C":(2, 0), "D":(3, 0), "E":(4, 0),
                           ...
                           "x":(10, 3), "y":(11, 3), "z":(12,3), "line_spacing":1} #The table with the positions of the letters
        
        self.spacing = {"A":(1, 0, 2, 0), "B":(1, 0, 2, 0), "C":(1, 0, 2, 0), "D":(1, 0, 2, 0), "E":(1, 0, 0, 0), "F":(1, 0, 0, 0),
                        "G":(1, 0, 0, 0), "H":(1, 0, 0, 0), "I":(2, 0,-1, 0), "J":(1, 0, 0, 0), "K":(1, 0, 0, 0), "L":(1, 0, 0, 0),
                        ...
                        "w":(0, 0, 1, 0), "x":(1, 0, 0, 0), "y":(1, 0, 0, 0), "z":(1, 0, 0, 0)}
...
if __name__ == "__main__":
    ...
    test_font = font(test_win, "./test_assets/standard")
    test_font.draw("ABCDEFGHIJKLM", 20, (5,5))
    p.display.flip()